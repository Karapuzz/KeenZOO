...
def security_checks():
    ...
    if request.method == 'POST':
        ...
        def _port_ok(parsed):
            ...
            return parsed.port in (None, LISTEN_PORT)
...
# dns4.2.23 (аудит A5 #1): таблица зарезервированных сетей. Должна быть
# СИНХРОННА awk-таблицам is_public_ipv4/is_public_cidr/is_public_range в
# unblock_ipset.sh и unblock_dnsmasq.sh — shell остаётся исполнителем
