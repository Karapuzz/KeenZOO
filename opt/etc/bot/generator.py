...
def setup_firewall(port):
    ...
    -D/-C намеренно вызываются с expected_rcs=(0, 1): «правила нет»
    (rc=1, Bad rule) для них — штатный ответ, а не ошибка, и не должен
    журналироваться в error.log.
    """
